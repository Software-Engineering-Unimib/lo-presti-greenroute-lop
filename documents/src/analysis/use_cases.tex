\newtcolorbox{usecasebox}[1][]{colback=gray!10,colframe=black, before upper=\small, before title=\small,, #1}
...
\begin{usecasebox}[title=Visualizza i percorsi possibili]
	...
	\textbf{Scenario di successo principale:}
	\begin{enumerate}[itemsep=0pt, topsep=0pt]
		\item Il sistema fornisce alla persona le informazioni della mappa e chiede di selezionare una posizione di partenza
		\item La persona richiede di visualizzare i percorsi verso una destinazione specifica
		\item Il sistema chiede di fornire una posizione di partenza o di annullare l'ultima scelta
		...
		Dà anche la possibilità di annullare l'ultima scelta
		\item La persona seleziona le modalità di trasporto dà consentire
		\item Il sistema chiede se i percorsi debbano dare priorità alla velocità, all’ecosostenibilità o fare un compromesso tra le due.
		Dà anche la possibilità di annullare l'ultima scelta
		\item La persona seleziona un’opzione tra le priorità dà applicare al percorso
		...
		Dà alla persona la possibilità di visualizzarne uno o annullare l'ultima scelta
		\item La persona seleziona un percorso dà visualizzare
		\item Il sistema mostra il percorso selezionato e dà alla persona la possibilità di annullare l'ultima scelta
	\end{enumerate}
	\vspace{1\baselineskip}

	\textbf{Estensioni:} \\
		\hspace*{1em} 3a.1 La persona chiede di annullare l'ultima scelta \\[0.5em]
		\hspace*{1em} 3a.2 Il caso d’uso riparte dal passo 1 \\[0.5em]
		\\
		\hspace*{1em} 5a.1 La persona chiede di annullare l'ultima scelta \\[0.5em]
		\hspace*{1em} 5a.2 Il caso d’uso riparte dal passo 3 \\[0.5em]
		\\
		\hspace*{1em} 7a.1 La persona chiede di annullare l'ultima scelta \\[0.5em]
		\hspace*{1em} 7a.2 Il caso d’uso riparte dal passo 5 \\[0.5em]
		\\
		\hspace*{1em} 9a.1 La persona chiede di annullare l'ultima scelta \\[0.5em]
		\hspace*{1em} 9a.2 Il caso d’uso riparte dal passo 7 \\[0.5em]
		\\
		\hspace*{1em} 11a.1 La persona chiede di annullare l'ultima scelta \\[0.5em]
		\hspace*{1em} 11a.2 Il caso d’uso riparte dal passo 9 \\[0.5em]
