\newcommand{\sdmessagearrow}[5][]{
  \draw[-{Latex[scale=1.6]}, #1] (#2, #4) -- (#3, #4) node[midway, above] {#5};
}

\newcommand{\sdresponsearrow}[5][]{
  \draw[dashed, -{Straight Barb[scale=1.6]}] (#2, #4) -- (#3, #4) node[midway, above] {#5};
}
...
\newcommand{\sdoperator}[4]{
	...
	\node[anchor= north west, xshift=0pt, yshift=0pt] (operatortext\theoperatortextcounter) at ($(operatortext\theoperatortextcounter.north east) + (7pt, 0pt)$) {#4};
}