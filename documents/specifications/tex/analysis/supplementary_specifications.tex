...
\begin{itemize}[label=-,itemsep=0pt, topsep=0pt]
	\item The technologies used to develop the app must enable building for both Android and iOS from a single codebase, without needing to test on both platforms
\end{itemize}
